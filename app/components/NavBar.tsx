...
export default function NavBar() {
  ...
  return (
  <header
    className="sticky top-0 z-50 mb-3 bg-white/95 px-4 pb-3 shadow-sm backdrop-blur"
    style={{
    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="max-w-[180px] overflow-hidden text-ellipsis whitespace-nowrap text-[11px] text-gray-500">
            {email}
          </div>
        </div>
      </div>
      ...
      <nav className="flex w-full gap-2 overflow-x-auto pb-1 sm:w-auto sm:justify-end sm:overflow-visible sm:pb-0">
        ...
        <button
          ...
          className="shrink-0 rounded-full bg-red-600 px-3 py-2 text-sm text-white sm:px-4"
        >
          Déconnexion
        </button>
      </nav>
